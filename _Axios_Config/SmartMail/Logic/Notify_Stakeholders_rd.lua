...
-- Log key data
--------------------------------------------------------------------------------------
LOGGER:info("Start of Notify_Stakeholders_rd.lua: \nACT_TYPE_SC: " .. (ACT_TYPE_SC or "") 
				.. ", \nEVENT_TYPE: " .. (EVENT_TYPE or "") 
				.. ", EVENT_REF: " .. (EVENT_REF or "") )

ITEM_USR_WHERE_SQL = "  usr_item_association_reasn.association_reason_sc like('STAKEHOLDER') and "

set_of_rules {
	{
	name = [[ "Notify Stakeholders Users" ]],
